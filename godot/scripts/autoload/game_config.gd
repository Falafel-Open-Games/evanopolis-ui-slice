...
@export_enum("600:600", "900:900", "1800:1800") var match_duration: int = 1800
@export var starting_fiat_balance: float = 20.0
@export var starting_bitcoin_balance: float = 0.0
...
@export var build_id: String = "mouppwtmlpon"
